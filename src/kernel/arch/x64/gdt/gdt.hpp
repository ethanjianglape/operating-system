...
inline constexpr std::uint8_t KERNEL_CODE = ACCESS_PRESENT | ACCESS_RING_0 | ACCESS_CODE_DATA | ACCESS_EXECUTABLE | ACCESS_READABLE;

inline constexpr std::uint8_t KERNEL_DATA = ACCESS_PRESENT | ACCESS_RING_0 | ACCESS_CODE_DATA | ACCESS_WRITABLE;

inline constexpr std::uint8_t USER_CODE = ACCESS_PRESENT | ACCESS_RING_3 | ACCESS_CODE_DATA | ACCESS_EXECUTABLE | ACCESS_READABLE;

inline constexpr std::uint8_t USER_DATA = ACCESS_PRESENT | ACCESS_RING_3 | ACCESS_CODE_DATA | ACCESS_WRITABLE;
