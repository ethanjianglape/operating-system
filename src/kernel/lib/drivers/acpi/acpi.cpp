...
namespace drivers::acpi {
    ...
    void parse_madt(ACPIHeader* header) {
        ...
        log::info("MADT:");
        log::info("length = ", fmt::hex{madt_length});
        log::info("local apic addr = ", fmt::hex{madt->lapic_addr});
        ...
        while (record_addr < madt_end) {
            ...
            case MADT_LAPIC: {
                ...
                log::info("Processor Local APIC:");
                log::info("acpi_id = ", acpi_id, ", apic_id = ", apic_id, ", flags = ", fmt::bin{flags});
                break;
            }
            case MADT_IOAPIC: {
                ...
                log::info("IOAPIC:");
                log::info("ioapic id = ", ioapic_id, ", ioapic addr = ", fmt::hex{ioapic_addr}, ", gsi base = ", fmt::hex{gsi_base});
            ...
            case MADT_IOAPIC_ISO: {
                ...
                log::info("bus = ", bus_src, ", irq = ", irq_src, ", gsi = ", gsi, ", flags = ", fmt::bin{flags});
                break;
            }
            case MADT_IOAPIC_NIS: {
                ...
                log::info("IOAPIC Non-maskable Interrupt Source:");
                log::info("NMI Source = ", nmi_source, ", Flags = ", fmt::bin{flags}, ", GSI = ", gsi);
            ...
            case MADT_LAPIC_NI: {
                ...
                log::info("LAPIC Non-maskable interrupts:");
                log::info("ACPI Processor ID = ", acpi_processor_id, ", LINT# = ", lint, ", Flags = ", fmt::bin{flags});
            ...
            case MADT_LAPIC_ADDR_OVERRIDE: {
                ...
                log::info("LAPIC Address Override:");
                log::info("LAPIC Address = ", fmt::hex{lapic_addr});
            ...
            case MADT_X2APIC: {
                ...
                log::info("Processor Local x2APIC:");
                log::info("Processor local x2APIC ID = ", x2_apic_id, ", ACPI ID = ", acpi_id, ", Flags = ", fmt::bin{flags});
    ...
    void init(void* rsdp_addr) {
        ...
        log::info("xsdt p   = ", fmt::hex{xsdt_phys});
        log::info("xsdt v   = ", fmt::hex{xsdt_virt});
        ...
        log::info("XSDT:");
        log::info("revision = ", xsdt->header.revision);
        log::info("length = ", xsdt->header.length);
        ...
        for (int i = 0; i < entries; i++) {
            ...
            log::info("Entry #", i, ": type='", (const char*)sig, "' len=", header->length);
